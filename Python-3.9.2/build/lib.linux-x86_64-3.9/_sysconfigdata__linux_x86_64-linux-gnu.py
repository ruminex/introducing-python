...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/workspace/introducing-python/Python-3.9.2/coverage.info',
 'COVERAGE_REPORT': '/workspace/introducing-python/Python-3.9.2/lcov-report',
 ...
 'abs_builddir': '/workspace/introducing-python/Python-3.9.2',
 'abs_srcdir': '/workspace/introducing-python/Python-3.9.2',
